...
<Step title="Identifiera dig">
  ...
  **Exempel:** "Hej, det är Johan från hemtjänsten."
</Step>

<Step title="Ställ din fråga">
  Fråga naturligt om det du undrar över.
  
  **Exempel:** "Vad gör jag om en klient har fått fall?"
</Step>
...
Du kan också söka i kunskapsbasen via webgränssnittet:
...
<Step title="Öppna kunskapsbasen">
  Klicka på "Kunskapsbas" i menyn.
</Step>

<Step title="Sök eller bläddra">
  - Använd sökfältet för att hitta specifik information
  - Bläddra bland kategorier
  - Öppna dokument och läs i detalj
</Step>
</Steps>
...
Administratörer och utsedda personer kan lägga till och uppdatera innehåll i kunskapsbasen.
...
<Accordion title="Vem kan lägga till innehåll i kunskapsbasen?">
  Det bestäms av din organisation. Vanligtvis har administratörer, chefer och utsedda super users rättighet att lägga till och redigera innehåll.
</Accordion>
